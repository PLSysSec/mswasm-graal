...
public class MSWasmSuite extends WasmSuiteBase {
    ...
    private WasmBinaryCase[] testCases = {
                    ...
                    WasmCase.create("HANDLELOADSTORE", WasmCase.expected(17),
                                    ...
                                    null, new Properties()),
                    WasmCase.create("HANDLELOADSTORE_TRAP", WasmCase.expectedThrows("invalid handle load", WasmCaseData.ErrorType.Runtime),
                    ...
                    WasmCase.create("FREESEGMENT_ADD", WasmCase.expected(24),
                                    ...
                                    null, new Properties()),
                    WasmCase.create("FREESEGMENT_TRAP", WasmCase.expectedThrows("free_segment failed: Handle: (0, 0, 8, false) does not exist", WasmCaseData.ErrorType.Runtime),
