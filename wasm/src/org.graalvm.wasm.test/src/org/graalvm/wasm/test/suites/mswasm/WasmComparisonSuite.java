...
public class WasmComparisonSuite extends WasmSuiteBase {
    ...
    private WasmBinaryCase[] testCases = {
                    ...
                    WasmCase.create("STORE_AND_LOAD_2", WasmCase.expected(0xfedc6543),
                                    parseWasmFile(folderPath + "wasm_store-load_2.wasm"),
                                    null, opts), 
                    ...
                    WasmCase.create("ADD_2", WasmCase.expected(0),
                                    parseWasmFile(folderPath + "wasm_add_2.wasm"),
                                    null, opts),
                    WasmCase.create("ADD_3", WasmCase.expected(0x12345678),
                                    parseWasmFile(folderPath + "wasm_add_3.wasm"),
                                    null, opts),
                    ...
                    WasmCase.create("ADD64_2", WasmCase.expected(1234567895L),
                                    parseWasmFile(folderPath + "wasm_add64_2.wasm"),
                                    null, opts),
                    WasmCase.create("HANDLEADDSUB_1", WasmCase.expected(9),
                                    parseWasmFile(folderPath + "wasm_handleaddsub_1.wasm"),
                                    null, opts),
                    WasmCase.create("HANDLEADDSUB_2", WasmCase.expected(-19),
                                    parseWasmFile(folderPath + "wasm_handleaddsub_2.wasm"),
                                    null, opts),
                    WasmCase.create("SEGMENTSLICE_0", WasmCase.expected(10),
                                    parseWasmFile(folderPath + "wasm_segmentslice_0.wasm"),
                                    null, opts),
                    WasmCase.create("SEGMENTSLICE_1", WasmCase.expected(10),
                                    parseWasmFile(folderPath + "wasm_segmentslice_1.wasm"),
                                    null, opts),
                    WasmCase.create("SEGMENTSLICE_2", WasmCase.expectedThrows("i32.segment_store failed: (Handle: (40, 0, 22, false), 10)", WasmCaseData.ErrorType.Validation),
                                    parseWasmFile(folderPath + "wasm_segmentslice_2.wasm"),
                                    null, opts), 
                    WasmCase.create("HANDLELOADSTORE", WasmCase.expected(17),
                                    parseWasmFile(folderPath + "wasm_handleloadstore.wasm"),
                                    null, opts),
                    WasmCase.create("HANDLELOADSTORE_TRAP", WasmCase.expectedThrows("handle.segment_load failed due to non-handle segment", WasmCaseData.ErrorType.Validation),
                                    parseWasmFile(folderPath + "wasm_handleloadstore_trap.wasm"),
                                    null, opts),
                    WasmCase.create("FREESEGMENT_ADD", WasmCase.expected(24),
                                    parseWasmFile(folderPath + "wasm_freesegment_add.wasm"),
                                    null, opts),
                    WasmCase.create("FREESEGMENT_TRAP", WasmCase.expectedThrows("free_segment failed: Handle: (0, 0, 8, false) does not exist", WasmCaseData.ErrorType.Validation),
                                    parseWasmFile(folderPath + "wasm_freesegment_trap.wasm"),
                                    null, opts),
                    WasmCase.create("HANDLELOADSTOREADD_1", WasmCase.expected(-1),
                                    parseWasmFile(folderPath + "wasm_handleloadstore_add_1.wasm"),
                                    null, opts),
                    WasmCase.create("HANDLELOADSTOREADD_2", WasmCase.expected(1040),
                                    parseWasmFile(folderPath + "wasm_handleloadstore_add_2.wasm"),
                                    null, opts),
    };
